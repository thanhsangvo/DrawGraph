...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DrawGraph",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9DrawGraph11AppDelegate")
...
SWIFT_CLASS("_TtC9DrawGraph13SceneDelegate")
...
SWIFT_CLASS("_TtC9DrawGraph14ViewController")
